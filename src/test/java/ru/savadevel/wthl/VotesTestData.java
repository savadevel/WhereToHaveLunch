...
public class VotesTestData {
    ...
    public static final VotesTo votesTo1 = new VotesTo(getVoteDay().getNow(), restaurant1, 1);
    public static final VotesTo votesTo2 = new VotesTo(getVoteDay().getNow(), restaurant2, 2);
}
